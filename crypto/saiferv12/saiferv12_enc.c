...
/* QUARTERROUND updates a, b, c, d with a saiferv12 "quarter" round. */
...
/* saiferv12_core performs 20 rounds of saiferv12 on the input words in
 * |input| and writes the 64 output bytes to |output|. */
static void saiferv12_core(saiferv12_buf *output, const u32 input[16])
{
    u32 x[16];
    int i;
    const union {
...
void saiferv12_ctr32(unsigned char *out, const unsigned char *inp,
